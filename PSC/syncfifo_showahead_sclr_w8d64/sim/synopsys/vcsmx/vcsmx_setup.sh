...
if [ $SKIP_COM -eq 0 ]; then
  vlogan +v2k $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/../fifo_191/sim/syncfifo_showahead_sclr_w8d64_fifo_191_qw52ykq.v" -work syncfifo_showahead_sclr_w8d64_fifo_191
  vlogan +v2k $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/syncfifo_showahead_sclr_w8d64.v"                                                                              
fi

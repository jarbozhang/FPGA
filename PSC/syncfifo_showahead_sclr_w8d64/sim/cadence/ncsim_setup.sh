...
TOP_LEVEL_NAME="syncfifo_showahead_sclr_w8d64"
QSYS_SIMDIR="./../"
QUARTUS_INSTALL_DIR="C:/quartus19.1/quartus/"
SKIP_FILE_COPY=0
SKIP_DEV_COM=0
SKIP_COM=0
SKIP_ELAB=0
...
mkdir -p ./libraries/syncfifo_showahead_sclr_w8d64_fifo_191/
...
if [ $SKIP_COM -eq 0 ]; then
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS           "$QSYS_SIMDIR/../fifo_191/sim/syncfifo_showahead_sclr_w8d64_fifo_191_qw52ykq.v" -work syncfifo_showahead_sclr_w8d64_fifo_191 -cdslib ./cds_libs/syncfifo_showahead_sclr_w8d64_fifo_191.cds.lib
  ncvlog -compcnfg $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/syncfifo_showahead_sclr_w8d64.v"                                                                                                                                                
fi
